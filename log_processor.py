...
for file in os.listdir(directory):
    ...
    for idx, line in enumerate(lines[1:len(lines)-1]):
        ...
        this_flight_dict["RPM"].append(unpacked_line[LogFmt.RPM])
        ...
        this_flight_dict["Instrument Temp"].append(unpacked_line[LogFmt.UNITT])
        this_flight_dict["Coolant Temp"].append(unpacked_line[LogFmt.COOL])
        this_flight_dict["Oil Temp"].append(unpacked_line[LogFmt.OILT])
        this_flight_dict["Oil Pressure"].append(unpacked_line[LogFmt.OILP])
